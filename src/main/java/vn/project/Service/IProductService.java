...
public interface IProductService {
	...
	Page<ProductsDTO> findAllDTO(Pageable pageable);

	Page<ProductsDTO> findAllSortedByPriceAsc(Pageable pageable);
	Page<ProductsDTO> findAllSortedByPriceDesc(Pageable pageable);
}