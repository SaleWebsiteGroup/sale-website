...
public class RegisterController {
	...
	public String register(@RequestParam String username, @RequestParam String password, @RequestParam String fullname,
			...
			@RequestParam(name = "argeement", defaultValue = "false") Boolean agreement, Model model) {
		...
		Users newUser = Users.builder().id(createUserid()).username(username).password(passwordEncoder.encode(password))
				.fullname(fullname).phonenumber(phonenumber).email(email).address(address).role(role).build();
	...
	public void SaveOldInfo(String username, String password, String fullname, String phonenumber, String email,
