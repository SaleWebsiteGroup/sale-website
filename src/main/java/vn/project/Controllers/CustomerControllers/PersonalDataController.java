...
public class PersonalDataController {
	...
	public String orders(Model model,
		...
		if (user != null) {
			...
			Page<Orders> orderPage = orderService.findOrdersByUserid(String.valueOf(user.getId()), pageable);
	...
	// Phương thức orders cũ không dùng nữa vì đã thay bằng phân trang
//	@GetMapping("/orders")
//	public String orders(Model model) {
//
//		Authentication auth = SecurityContextHolder.getContext().getAuthentication();
