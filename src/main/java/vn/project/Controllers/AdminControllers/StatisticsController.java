...
public class StatisticsController {
	...
	public String statistics(Model model) {
		...
		model.addAttribute("RevenueForMonth", RevenueForMonth); // lấy trên view bằng revenue : RevenueForMonth,
																// revenue.key với revenue.value
		...
		for (int i = 0; i < 7; i++) {
			...
			newRevenue = returnRevenue(list);
			System.out.print(newRevenue);
			System.out.print(RevenueForWeek);
