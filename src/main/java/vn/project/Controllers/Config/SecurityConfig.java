...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.csrf(csrf -> csrf.disable()).authorizeHttpRequests((authorize) -> authorize
				.requestMatchers("/login", "/login/**", "/register", "/forgotpass", "/authenticationotp", "/newpass",
						"/exception/**", "/assets/css/**", "/assets/js/**", "/assets/images/**", "/assets/fonts/**")
				.permitAll().requestMatchers("/product/**", "/home", "/", "/exception/**").permitAll()
